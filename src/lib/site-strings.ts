...
export const SITE_STRINGS_EN = {
  ...
  testimonials_form_help: "Your review appears on the site right away. Sign in to manage your reviews on the My Reviews page.",
  ...
  testimonials_btn_send: "Submit review",
  testimonials_btn_sending: "Submitting...",
  testimonials_my_reviews: "My reviews",
  testimonials_traveler: "Traveler",
  testimonials_error_load: "Couldn't load reviews",
  testimonials_retry: "Try again",
  testimonials_toast_ok: "Your review has been submitted successfully!",
...
export const SITE_STRINGS_NE: Record<SiteStringKey, string> = {
  ...
  testimonials_form_help:
    "तपाईंको प्रतिक्रिया तुरुन्तै साइटमा देखिन्छ। साइन इन गरेर मेरो प्रतिक्रियामा व्यवस्थापन गर्नुहोस्।",
